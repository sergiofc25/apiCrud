    ...
    public Ent_Presupuesto Obten_x_Id(int Pre_Id)
    {
        ...
        if (oDR.HasRows)
        {
            ...
            return new Ent_Presupuesto
            {
                ...
                Pre_GastosGenerales = oDR.IsDBNull(oDR.GetOrdinal("Pre_GastosGenerales")) ? null : oDR.GetDecimal(oDR.GetOrdinal("Pre_GastosGenerales")),
                Pre_Utilidad = oDR.IsDBNull(oDR.GetOrdinal("Pre_Utilidad")) ? null : oDR.GetDecimal(oDR.GetOrdinal("Pre_Utilidad")),
                Pre_IGV = oDR.IsDBNull(oDR.GetOrdinal("Pre_IGV")) ? null : oDR.GetDecimal(oDR.GetOrdinal("Pre_IGV")),
                Pre_Jornal = oDR.GetDecimal(oDR.GetOrdinal("Pre_Jornal")),
                Pre_Estado = oDR.GetByte(oDR.GetOrdinal("Pre_Estado")) != 0 ? true : false,
            };
        }
